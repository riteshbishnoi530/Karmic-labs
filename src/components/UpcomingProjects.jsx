...
function UpcomingProjects() {
    return (
        <div id='projects' className='relative pt-20 pb-[136px] max-lg:pb-24 max-md:pb-16 max-md:pt-0'>
            <img className='absolute max-lg:hidden bottom-0 max-w-[182px] right-0' src="/assets/images/upcoming-right-img.webp" alt="upcoming image" />
