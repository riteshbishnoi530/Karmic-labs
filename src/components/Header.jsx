        ...
        <div className='pt-3.5 px-4 overflow-hidden min-[1921px]:max-w-[1920px] mx-auto'>
            <div className='container flex justify-between items-center'>
                ...
                <div onClick={toggleSidebar} className='z-[15] flex-col gap-1 lg:hidden flex'>
                    <span className={`${open ? 'w-8 h-1 bg-red-500 rotate-45 translate-y-3 duration-300 ease-linear rounded' : 'w-8 h-1 bg-red-500 duration-300 ease-linear rounded'}`}></span>
                    <span className={`${open ? 'w-8 h-1 bg-red-500  opacity-0 duration-300 ease-linear' : 'w-8 h-1 bg-red-500 duration-700 ease-linear rounded'}`}></span>
                    <span className={`${open ? 'w-8 h-1 bg-red-500 -rotate-45 -translate-y-1 duration-300 ease-linear rounded' : 'w-8 h-1 bg-red-500 duration-300 ease-linear rounded'}`}></span>
                </div>
            </div>
        </div>
    )
